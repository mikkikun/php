                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('App\Http\Controllers\Admin\PostController@update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-md-12">
                                <label>タイトル</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" required autocomplete="text" value="{{ $post_form->title }}">
                                <p></p>
                                <label  style= "font-size:20px;">本文</label>
                                <textarea class="form-control @error('text') is-invalid @enderror" name="body" required autocomplete="text" rows="4">{{ $post_form->body }}</textarea>
                                @error('text')
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-12 text-right">
                                ...
                                <select type="text" class="@error('select') is-invalid @enderror" name="cardgame" required autocomplete="select" value="{{ $post_form->cardgame }}">
